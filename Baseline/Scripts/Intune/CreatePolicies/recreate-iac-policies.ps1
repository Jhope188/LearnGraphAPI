...
param(
    ...
    [string]$ImportPath = "/Users/jon/Desktop/BaslineSetup/IAC-Policies-JSON",
...
if (-not (Test-Path $ImportPath)) {
    ...
    Write-Host "   Please run export-iac-policies-json.ps1 first to export policies.`n" -ForegroundColor Yellow
    exit
}
